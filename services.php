...
<html lang="en">
<?php
$title = 'EION Digital: Our Services';
include './head.php';
?>
...
<body>
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
          <div
            ...
            <p class="m-0">We're helping our customer to increase there business through digital marketing.</p>
  ...
  <?php include('./widgets/testmonial.php') ?>
