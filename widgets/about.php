    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <p class="mb-4">
                    EION Digital is an IT services and business solutions company. We
                    believe innovation and collective knowledge can transform all our
                    futures with greater purpose. We Develops, markets and supports
                    software for digital transformation to increase business
                    resilience, improve operational efficiency and deepen client
                    engagement.
                </p>
