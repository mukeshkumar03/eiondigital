        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                <div
                    ...
                    <h4 class="mb-3">Intershop Development</h4>
                    <p class="m-0">Digitalize and transform client's business with Intershop e-commerce platform.</p>
                    <a class="text-uppercase mt-2" href="intershop">Read More <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                <div
                    ...
                    <p class="m-0">We're helping our customer to increase there business through digital marketing via
                        SEO and
                        SMO.</p>
